...
# sam1
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g1_h5/" )
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g1_n2/" )

# sam2
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g2_h5/" )
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g2_n2/" )

# sam3
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g3_h5/" )
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g3_n2/" )

# sam4
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g4_h5/" )
.aa_recon( folderdir = "./h5_n2/dS/h5n2_g4_n2/" )
...
# g1
.root_seq(  seqfile = "./h5_n2/pHA_h5n2_g1.fasta", treefile = H5_treefile, originfas = H5_seq )
.root_seq(  seqfile = "./h5_n2/pNA_h5n2_g1.fasta", treefile = N2_trefile, originfas = N2_seq )

# g2
.root_seq(  seqfile = "./h5_n2/pHA_h5n2_g2.fasta", treefile = H5_treefile, originfas = H5_seq )
.root_seq(  seqfile = "./h5_n2/pNA_h5n2_g2.fasta", treefile = N2_trefile, originfas = N2_seq )

# g3
.root_seq(  seqfile = "./h5_n2/pHA_h5n2_g3.fasta", treefile = H5_treefile, originfas = H5_seq )
.root_seq(  seqfile = "./h5_n2/pNA_h5n2_g3.fasta", treefile = N2_trefile, originfas = N2_seq )

# g4
.root_seq(  seqfile = "./h5_n2/pHA_h5n2_g4.fasta", treefile = H5_treefile, originfas = H5_seq )
.root_seq(  seqfile = "./h5_n2/pNA_h5n2_g4.fasta", treefile = N2_trefile, originfas = N2_seq )


# aa reconstruction  -----------------------------------------------------

# sam1
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g1_h5/" )
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g1_n2/" )

# sam2
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g2_h5/" )
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g2_n2/" )

# sam3
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g3_h5/" )
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g3_n2/" )

# sam4
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g4_h5/" )
.aa_recon( folderdir = "./h5_n2/dS_r/h5n2_g4_n2/" )
